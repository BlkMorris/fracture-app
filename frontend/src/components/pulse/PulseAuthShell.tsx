...
import { pulseChromeStyles, PulseMark } from "@/components/pulse/PulseChrome";
  ...
  return (
    <main className="pulse-auth">
      ...
      <section className="pulse-auth-panel">
        ...
        <div className="pulse-auth-product">Pulse <PulseMark /></div>
